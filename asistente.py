...
class Berna(tk.Tk):
    ...
    def _mensajes(self):
        ...
        sis += ("\n\nTIENES HERRAMIENTAS DE VERDAD y debes usarlas en vez de decir que no "
                ...
                "bueno, hora_dorada le dice cuando hay luz de la buena y "
                "calibrar_gimbal le guia si la camara sale torcida. Con sus "
                ...
                "paso: mirar y buscar no molestan a nadie. Respeta los permisos "
                "guardados para descargas y aplicaciones; para instalar, ejecutar "
                "ordenes o escribir sigue pidiendo permiso. En modo Codex eres "
                "mas breve, mas operativa "
